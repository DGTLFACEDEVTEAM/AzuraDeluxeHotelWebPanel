...
export async function GET(_request, { params }) {
  ...
  if (!Array.isArray(segments) || segments.length !== 3 ||
      segments[0] !== "pages" || !["homepage", "rooms", "restaurants", "about", "spawellness", "spor", "beachpools", "kidsclub", "bars", "deluxeroom", "familyroom", "fantasyroom", "room-options"].includes(segments[1]) ||
